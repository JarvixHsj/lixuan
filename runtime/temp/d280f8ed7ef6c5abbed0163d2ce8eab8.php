<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/Library/WebServer/Documents/testGit/Think5Admin/application/admin/view/plugs.upfile.html";i:1497187871;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
    <head>
            ...
            $(function () {
                ...
                WebUploader.Uploader.register({'before-send-file': 'preupload'}, {preupload: function (file) {
                        ...
                        owner.md5File(file.source).fail(function () {
                            ...
                            $.ajax("<?php echo url('admin/plugs/upstate'); ?>", {dataType: 'json', method: 'post', data: data, success: function (ret) {
                ...
                uploader = WebUploader.create({
                    ...
                    accept: {
                        title: '选择文件',
                        extensions: '<?php echo $types; ?>', //'gif,jpg,jpeg,bmp,png',
                        mimeTypes: '<?php echo $mimes; ?>'
                    },
                    formData: {},
                    /*<?php if($mode === 'one'): ?>*/
                    auto: true,
