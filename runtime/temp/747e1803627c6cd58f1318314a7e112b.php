<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/Library/WebServer/Documents/lixuan/application/html/view/login.index.html";i:1498056040;s:73:"/Library/WebServer/Documents/lixuan/application/extra/view/html.main.html";i:1497950307;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
	...
	<div class="mui-content">
	    ...
	    <form action="__SELF__" method="post">
    		...
    		<button class="log_btn" type="submit">登录</button>
	    </form>
	</div>
